  ...
  return (
    <div className="menu-container">
      <div className='hidden md:flex flex-row-reverse space-x-5 mr-3 font-bold items-center justify-center text-center'>
        <Link href={"https://wa.me/message/ZWN45EC2PODYG1"} className='px-5 py-2 ml-5 rounded-2xl bg-sky-500 hover:bg-sky-800 hover:text-white hover:px-6 hover:py-3 ease-out duration-300'>احجز ميعادك</Link>
        ...
        <Link href={"/posts"} className='text-sky-950 text-lg hover:text-xl hover:text-sky-600 ease-out duration-300'>مقالات</Link>
